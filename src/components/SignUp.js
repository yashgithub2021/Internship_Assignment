                ...
                <Card style={{ width: '28rem', position: 'relative', height: '32rem', backgroundColor: '#1d2c4e', boxshadow: '0px 20px 25px -13px rgba(0, 0, 0, 1)' }}>
                    ...
                    <Card.Body className='px-5'>
                        <form className='container' onSubmit={signUp}>
                            ...
                            <Row>
                                <Col xs={6}>
                                    <InputGroup style={{ height: "3rem" }} data-bs-theme="dark" className="mt-5 mb-2">
                                        <InputGroup.Text onChange={onChange} id="basic-addon1"><i className="fa-solid fa-user"></i></InputGroup.Text>
                                        <Form.Control
                                            name='name'
                                            onChange={onChange}
                                ...
                                <Col xs={6}>
                                    <Form>
                                        <Form.Group data-bs-theme="dark" controlId="exampleForm.DateInput" className="mt-5 mb-2">
                                            <Form.Control name='dob' value={credentials.dob} onChange={onChange} style={{ height: "3rem" }} type="date" placeholder="Enter DOB" />
                                        </Form.Group>
                                    </Form>
                                </Col>
                            </Row>
                            ...
                            <Row style={{ fontSize: '13px' }}>
                                <Col xs={12} className="text-end" style={{ color: 'white' }}>Already Have Account?
                                    <Link to="/login" style={{ color: 'rgb(0, 245, 225)', textDecoration: 'none' }}> Login</Link>
                                </Col>
                            </Row>
                            <Row className='mt-4'>
                                <Col xs={12}>
                                    <button type="submit" style={{ width: '100%', borderRadius: '12px' }} className="btn">
                                        SIGN UP
                                    </button>
                                </Col>
                            </Row>
